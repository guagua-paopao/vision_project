            ...
            if (subscription->tryReadLatest(frame) && frame.frame) {
                ...
                if (age_ms <= stale_frame_timeout_ms_) {
                    ...
                    if (analysis_due) {
                        ...
                        analysis_job.analysis_config_version =
                        ...
                        analysis_job.reconnect_count = hub.reconnect_count;
                        analysis_job.capture_fps = hub.capture_fps;
                        analysis_job.source_fps = hub.source_fps;
                        analysis_job.latest_frame_age_ms =
