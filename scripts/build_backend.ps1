...
$build = @("--build", $BuildPath, "--config", "Release", "--target",
    ...
    "camera_task_manager_test", "camera_inference_pool_test", "camera_algorithm_processor_test",
    "callback_delivery_worker_test", "callback_http_transport_test",
    "algorithm_runtime_heartbeat_test", "algorithm_service_integration_test",
